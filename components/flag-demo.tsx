 ...
 * the live Inboxed panel beside it. On scroll-into-view a scan sweeps the
      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-ink-soft">
            Inboxed reads your draft against the rules real spam filters use and
            ...
            <div className="grid md:grid-cols-[1.55fr_1fr]">
              ...
              <div className="bg-cream p-5">
                ...
                <div className="mt-4 flex items-center gap-1.5 border-t border-line pt-3 text-[11px] text-muted">
                  <span>🔒</span>
                  <span>
                    Runs privately in your browser · <b className="text-ink-soft">Inboxed</b>
                  </span>
                </div>
              </div>
            </div>
