...
export const metadata: Metadata = {
  title: "Data & Security — Inboxed",
  description:
    "How Inboxed handles your data. Your emails are analyzed on your device and never sold. Plain-English, no fine print.",
};
...
const PILLARS = [
  ...
  },
  {
    ...
    body: "Inboxed uses deterministic rules — the same kind spam filters use — not a large language model. Nothing gets sent off to be “trained on.”",
  },
];
        ...
        <section className="bg-grain border-b border-line">
          <div className="mx-auto max-w-3xl px-5 py-16 text-center sm:px-8 sm:py-24">
            ...
            <p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-ink-soft">
              We built Inboxed so you never have to trade privacy for a better
          ...
          <Reveal>
            <div className="mx-auto mt-16 max-w-2xl">
              ...
              <p className="mt-3 text-base leading-relaxed text-ink-soft">
                When you connect the Inboxed extension to Gmail, we only touch the
              ...
              <div className="mt-12 rounded-[var(--radius-xl)] border border-line bg-cream-deep/40 p-6">
                <p className="text-base leading-relaxed text-ink-soft">
                  ...
                  <span className="font-semibold text-ink">hello@inboxed.app</span>{" "}
